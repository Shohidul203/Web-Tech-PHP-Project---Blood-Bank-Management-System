                ...
                <fieldset>
                  ...
                  <?php if ($_SESSION['user']['role'] == "Donor") { ?>
                    ...
                    <select id="availability" name="availability">
                      <option value="Available" <?php if ($user[0]['availability'] == 'Available')
                        echo "selected"; ?>>
                        Available</option>
                      <option value="Not Available" <?php if ($user[0]['availability'] == 'Not Available')
                  ...
                  <br /><br />
                  <input type="button" name="submit" value="Save" onclick="editProfile()" />
                  <br /><br />
                </fieldset>
              </td>
            </tr>
