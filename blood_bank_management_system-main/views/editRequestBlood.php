    ...
    <table border="0" width="100%">
        ...
        <td>
            ...
            <fieldset>
                ...
                <br /><br />
                Location:
                <input type="text" name="location" id="location" value="<?=$requestBlood[0]['location']?>" required />
                <br /><br />
                Date:
                <input type="date" name="date" id="date" value="<?=$requestBlood[0]['date']?>" required />
                <br /><br />
                Mobile Number:
                <input type="text" name="mobileNumber" id="mobileNumber" value="<?=$requestBlood[0]['mobileNumber']?>" required />
                <br /><br />
                Comment:
                ...
                <br /><br />
                <input type="submit" name="submit" value="Submit" onclick="requestBlood()" />
                <br /><br />
            </fieldset>
            </form>
        </td>
