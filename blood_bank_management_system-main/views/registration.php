      ...
      <tr>
        ...
        <td>
          ...
          <form name="registration" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
            enctype="multipart/form-data" onsubmit="register()">
            <br />
            ...
            <!-- <input type="text" name="bloodGroup" value="<?php
            //  echo $bloodGroup; 
            ?>" />
            <br /> -->
            <select name="bloodGroup" id="bloodGroup" required value="<?php echo $bloodGroup; ?>">
